...
class MAX30100(object):
    ...
    def read_sensor(self):
        ...
        # Add latest values and keep only the latest `max_buffer_len` samples.
        self.buffer_ir = (self.buffer_ir[-self.max_buffer_len:] + [bytes[0] << 8 | bytes[1]])[-self.max_buffer_len:]
        self.buffer_red = (self.buffer_red[-self.max_buffer_len:] + [bytes[2] << 8 | bytes[3]])[-self.max_buffer_len:]
